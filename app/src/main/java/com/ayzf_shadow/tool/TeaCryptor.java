...
public class TeaCryptor
{
    ...
    private byte[] encipher(byte[] in)
    {
        ...
        long y = buf.readUnsignedInt();
        long z = buf.readUnsignedInt();
		buf.readerIndex(0);
        buf.writerIndex(0);
        buf.writeBytes(key);
        long a = buf.readUnsignedInt();
        long b = buf.readUnsignedInt();
        long c = buf.readUnsignedInt();
        long d = buf.readUnsignedInt();
        ...
        buf.writeInt((int)y);
        buf.writeInt((int)z);
		byte[] u= new byte[buf.readableBytes()];
        buf.readBytes(u);
		return u;
    }
