...
public class wtlogin_requireunlockcode extends wtlogin_login
{

	private String code;
    public wtlogin_requireunlockcode(int i2,String code) {
        super(i2);
        this.code = code;
    }
    ...
    public byte[] a(long j2, int i2, long j3) {
		...
		mark15_classa.writeBytes(t017c(code));
		mark15_classa.writeBytes(t401(new byte[16],new byte[16],new byte[16]));
		mark15_classa.writeBytes(t0198(0));
        return mark15_classa.getDataAndDestroy();
    }
