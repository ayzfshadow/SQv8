...
import saki.qq.datapacket.pack.packagea.mark16_classb;
import saki.qq.datapacket.pack.packagea.mark16_classd;

public class Refriendlist_getTroopMemberList extends mark14_classap {
    public mark16_classb a = new mark16_classb();

    public Refriendlist_getTroopMemberList(byte[] bArr) {
        super(bArr);
        ...
        if (mark10_classd.readInt() == mark10_classd.restByteCount() + 4) {
            ...
            HashMap hashMap2 = (HashMap) mark2_classd2.readMap((HashMap) hashMap, 0, true);
            for (Object str : hashMap2.keySet()) {
                this.a = (mark16_classb) new JceInputStream((byte[]) hashMap2.get((String)str)).read((JceStruct) this.a, 0, true);
            }
        }
    }
}
